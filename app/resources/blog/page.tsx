...
export const metadata: Metadata = {
  title: "Blog",
  description:
    "Operator-grade marketing notes from Thornwell Media. New posts published as the work surfaces them.",
  alternates: { canonical: "/resources/blog/" },
};

export default function ResourcesBlogIndex() {
  return (
    <>
      <SchemaJsonLd
      ...
      <section className="on-dark relative overflow-hidden bg-ink text-paper">
        <Image
          ...
          alt="Thornwell Media editorial workspace"
          fill
          priority
          sizes="100vw"
        ...
        <Container>
          <div className="relative pb-24 pt-32 md:pb-32 md:pt-40">
            <SectionLabel number="01" label="Blog" variant="dark" />
        ...
        <Container>
          <div className="py-20 md:py-28">
            <div className="max-w-3xl">
              <SectionLabel number="02" label="Latest posts" />
            ...
            {ARTICLES.length === 0 ? (
              <div className="mt-14 rounded-2xl border border-paper-edge bg-white p-10 text-center">
                <p className="font-serif text-xl text-navy-900">
                  First posts publishing this quarter.
                </p>
                <p className="mt-3 text-navy-700">
                  Subscribe to the Quarterly POV in the footer to be notified when the
                  first notes ship.
                </p>
              </div>
            ) : (
      ...
      <CTASection
        eyebrow="Quarterly POV"
        number="03"
        title="A short paper, four times a year."
        description="Twelve to sixteen pages. Operator-led. No promotion. Mailed to principals and CMOs. Free."
      />
    </>
  );
}
